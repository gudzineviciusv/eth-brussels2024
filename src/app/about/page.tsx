            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8 w-full max-w-7xl">
                ...
                <div className="col-span-1 p-4 bg-white rounded-lg shadow-md">
                    ...
                    <p className="text-gray-700">
                        ...
                        Select your trusted ‘Dead Moderator’ — because nothing says ‘I trust you’ like assigning someone
                        to declare you officially deceased. This chosen one will trigger a smart contract
                        that sets off the chain of events ensuring your financial legacy is handled. Think of it as
                        giving someone the keys to your posthumous kingdom!
                    </p>
                </div>
                ...
                <div className="col-span-1 p-4 bg-white rounded-lg shadow-md">
                    ...
                    <p className="text-gray-700">
                        ...
                        "When you kick the bucket, your ‘Dead Moderator’ will press the big red button—well, it’s not
                        actually red, but you get the idea. This triggers a smart contract that spreads the word
                        (on the blockchain) that you've shuffled off this mortal coil. No telegrams needed here!"
                    </p>
                </div>
                <div className="col-span-1 flex justify-center items-center bg-white rounded-lg shadow-md p-4">
                ...
                <div className="col-span-1 p-4 bg-white rounded-lg shadow-md">
                    ...
                    <p className="text-gray-700">
                        ...
                        giving you a window to say, ‘I’m not dead yet!’ If you’re alive and kicking, you can cancel the
                        death announcement before it’s too late.
                    </p>
                </div>
                ...
                <div className="col-span-1 p-4 bg-white rounded-lg shadow-md">
                    ...
                    <p className="text-gray-700">
                        ...
                        inherit your crypto treasures. Specify who gets what—whether it’s your best friend, your
                        sibling, or even your favorite barista. Spread the wealth with personalized allocations!"
                    </p>
                </div>
                <div className="col-span-1 flex justify-center items-center bg-white rounded-lg shadow-md p-4">
                ...
                <div className="col-span-1 p-4 bg-white rounded-lg shadow-md">
                    ...
                    <p className="text-gray-700">
                        ...
                        whitelist, and leave them a special goodbye message. Whether it’s heartfelt words of wisdom or a
                        witty one-liner, your legacy will live on with a personal touch."
                    </p>
                </div>
                ...
                <div className="col-span-1 p-4 bg-white rounded-lg shadow-md">
                    ...
                    <p className="text-gray-700">
                        "Here’s where it gets high-tech. Once your ‘Dead Moderator’ confirms your passing, a QR code is
                        generated. Print this code and attach it to your coffin—yes, you read that right.
                        Mourners will scan the QR code at your funeral, sign a transaction with their wallets, and
                        voila! The smart contract verifies their identity and sends them their assigned tokens. It’s
                        like a final parting gift, with a touch of crypto magic!"
                    </p>
                </div>
                ...
                <div className="col-span-1 md:col-span-2 p-4 bg-white rounded-lg shadow-md">
                    ...
                    <p className="text-gray-700">
                        Meet our amazing team! We are a group of dedicated professionals with a passion for innovation
                        and blockchain technology. Our goal is to make sure your financial legacy is secure and properly
                        managed even after you are no longer around.
                    </p>
                </div>
                <div
